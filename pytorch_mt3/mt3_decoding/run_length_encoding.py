...
"""Tools for run length encoding. Vendored from MT3, TF/seqio deps removed.

Training-only functions (extract_target_sequence_with_indices,
remove_redundant_state_changes_fn, run_length_encode_shifts_fn,
merge_run_length_encoded_targets) have been removed as they depend on
TensorFlow and are not needed for inference.
"""
